<script lang="ts">
    import type {TimeBet} from "$lib/types/motorsport.ts";
    import {getF1TimeFromMilliseconds, getTimeBetPointsColor} from "$lib/utils/motorsport/pick-the-grid/bets.ts";
